...
const matchdays = [
  ...
  // ── SPECIAL EDITION · Curtain-Raiser ──────────────────────────────────────
  {
    ...
    headline:'Before a Ball Is Kicked',
    deck:'On the eve of the largest World Cup ever staged, The Football Dispatch surveys forty-eight nations, twelve groups, and one trophy — and dares an opening verdict.',
    matches:[
      {
        id:'m0', group:'A to L', home:'Spain', hf:'🇪🇸', away:'Argentina', af:'🇦🇷',
        prediction:[2,1], confidence:'low',
        thoughts:'There is a particular quiet that settles over football in the days before a World Cup — a held breath, a stillness that belongs to no other moment in the sport. The bunting is up across sixteen cities in three nations. The pitches at the Azteca and MetLife and SoFi have been cut and watered and cut again. Forty-eight teams have arrived, each carrying the hopes of a country and the private arithmetic of its own ambition. By Sunday the noise will be deafening. For now there is only anticipation, and the oldest question in the game: who will lift the trophy in Philadelphia on the nineteenth of July?</p><p>It begins, as it must, with the hosts. Mexico open the tournament at a renovated Azteca two and a half thousand metres above the sea, a stadium that has now staged a World Cup opener three times and forgiven none of its visitors the altitude; Group A asks whether Javier Aguirre\'s side can convert home advantage into something more lasting than a good first night, with Korea and a stubborn Czechia in close attendance. To the north, Canada carry Group B and a nation only beginning to believe, their fortunes tethered to the fitness of Alphonso Davies, while Switzerland\'s quiet machinery and a Bosnia side who buried Italy in the play-offs promise to make the opening days anything but comfortable.</p><p>Group C is the romantics\' choice: Brazil, remade under Carlo Ancelotti and still searching for the rhythm of old, share a stage with a Morocco side who reached a semi-final in Qatar and have forgotten how to be intimidated, a Scotland returned at last after twenty-eight years in the wilderness, and a Haiti whose mere presence is a triumph over circumstance. Group D belongs to the United States, to Mauricio Pochettino and the most gifted generation American football has produced, though Türkiye\'s young artistry and a combative Paraguay will not defer politely to the host\'s timetable.</p><p>In Group E a youthful Germany rebuilds in public, watched by an Ecuador that defends like a closed door and a Curaçao whose qualification — the smallest nation ever to reach a World Cup — is its own kind of miracle. Group F gathers the Netherlands\' burnished talent, a Japan side who have quietly become Asia\'s most coherent footballing project, and a Sweden chasing the standards of a previous golden age.</p><p>Group G offers the melancholy of Belgium\'s fading golden generation set against the enduring brilliance of Mohamed Salah\'s Egypt, with Iran\'s organisation and New Zealand\'s honest endeavour completing the picture. And then Group H, where the eye lingers: Spain, European champions and, by common consent, the finest team on the planet, drawn alongside a Uruguay reimagined under Marcelo Bielsa, a Saudi Arabia that has humbled giants before, and Cape Verde, debutants whose island nation of half a million souls has assembled a team nobody wishes to play.</p><p>Group I carries thunder: France and Kylian Mbappé, Senegal\'s power, and — finally, gloriously — Erling Haaland at a World Cup, Norway\'s long exile ended. Group J is the one the heart cannot ignore, for it holds Argentina, the holders, and the near-certainty that this is Lionel Messi\'s last act upon this stage, a farewell stretched across a continent, with Algeria, Austria and Jordan cast as supporting players to a story the whole world will watch.</p><p>Group K asks whether Cristiano Ronaldo, too, has one final summer in him, his Portugal flanked by a vibrant Colombia and the unknowns of DR Congo and Uzbekistan. And Group L closes the draw with England\'s perennial, aching question — whether this, at last, is their year — set beside Croatia and the long goodbye of Luka Modrić, a Ghana reborn, and a Panama who fear no reputation.</p><p>Twelve groups, then; forty-eight stories, each convinced of its own ending. But tournaments are clarifying things, and when the noise subsides and the field narrows through a knockout bracket longer than any in the sport\'s history, the Dispatch expects the two poles of the modern game to be left standing — Spain, young and merciless and in full command of the ball, against Argentina, weathered and proud and chasing one last coronation for the greatest of them all.',
        summary:'Our verdict, offered before a ball is kicked and held lightly: Spain to be crowned in Philadelphia, with Argentina the vanquished finalists in a match that would set the game\'s bright new order against its most beloved champion. Two goals to one — the torch passed, Messi\'s farewell falling agonisingly short, a new name learning the weight of the trophy. There is a long and beautiful month between this prediction and its reckoning. Let it begin.'
      },
    ]
  },
